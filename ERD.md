...
| POST | `/users/me/avatar` | Upload profile picture (form-data: avatar) |
...
| GET | `/leaderboard` | Get leaderboard (query: type=weekly/monthly/all_time) |
...
```json
{
  ...
  "user": {
    "id": "7bf4992c-8291-4470-95c6-9b8b31466e23",
    "email": "user@example.com",
    "username": "",
    "provider": "local",
    "is_verified": false
